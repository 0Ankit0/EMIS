...
class AttendanceItemModelTest(TestCase):
    """Test AttendanceItem model"""
    ...
    def setUp(self):
        ...
        self.item = AttendanceItem.objects.create(
            name='Test Item',
    ...
    def test_item_creation(self):
        ...
        self.assertTrue(isinstance(self.item, AttendanceItem))
