...
class AdmissionsItemModelTest(TestCase):
    """Test AdmissionsItem model"""
    ...
    def setUp(self):
        ...
        self.item = AdmissionsItem.objects.create(
            name='Test Item',
    ...
    def test_item_creation(self):
        ...
        self.assertTrue(isinstance(self.item, AdmissionsItem))
...
class AdmissionsViewsTest(TestCase):
