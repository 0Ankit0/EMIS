...
class ExamsItemModelTest(TestCase):
    """Test ExamsItem model"""
    ...
    def setUp(self):
        ...
        self.item = ExamsItem.objects.create(
            name='Test Item',
    ...
    def test_item_creation(self):
        ...
        self.assertTrue(isinstance(self.item, ExamsItem))
...
class ExamsViewsTest(TestCase):
    ...
    def test_dashboard_view(self):
        """Test dashboard view"""
        response = self.client.get(reverse('exams:dashboard'))
