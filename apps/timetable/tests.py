...
class TimetableItemModelTest(TestCase):
    """Test TimetableItem model"""
    ...
    def setUp(self):
        ...
        self.item = TimetableItem.objects.create(
            name='Test Item',
    ...
    def test_item_creation(self):
        ...
        self.assertTrue(isinstance(self.item, TimetableItem))
